...
public class CassandraUtils {
    ...
    public static final int FETCH_IN_ADVANCE = 1000;
    ...
    private static boolean fetchNeeded(ResultSet resultSet) {
        return resultSet.getAvailableWithoutFetching() == FETCH_IN_ADVANCE
